...
class RalphAgent:
    ...
    def _escalate(self, detector: StuckDetector, why: str) -> None:
        ...
        try:
            ...
            # ISSUE #193 — the budget now follows the escalated model's context window
            # (e.g. lift qwen3:4b's 32768 to DeepSeek/GLM's documented window) so the live
            # page snapshot is no longer truncated to the local model's cap post-escalation.
