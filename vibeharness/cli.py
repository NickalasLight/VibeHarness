...
"""
    ...
    # Per-role endpoint selection (issue #163). A role can be driven local↔API purely by
    # naming a provider; the matching model id pairs with it. These are convenience flags
    # over the general `--set models.<role>.<field>` dotted keys.
